...
public class PingManager {
     ...
     */
    public static PingManager onAddress(String address) {
        PingManager pingManager = new PingManager();
        pingManager.setAddressString(address);
        return pingManager;
    }
     ...
     * @return this object to allow chaining
     */
    public static PingManager onAddress(InetAddress ia) {
        PingManager pingManager = new PingManager();
        pingManager.setAddress(ia);
        return pingManager;
    }
     ...
     * @return this object to allow chaining
     */
    public PingManager setTimeOutMillis(int timeOutMillis) {
     ...
     * @return this object to allow chaining
     */
    public PingManager setDelayMillis(int delayBetweenScansMillis) {
     ...
     * @return this object to allow chaining
     */
    public PingManager setTimeToLive(int timeToLive) {
     ...
     * @return this object to allow chaining
     */
    public PingManager setTimes(int noTimes) {
